...
def main() -> None:
    ...
    if not args.skip_cache and (args.force_cache or not has_latents(args.latents)):
        command = [
            sys.executable,
            "scripts/data/cache_sdvae_latents.py",
            "--images",
            args.images,
            "--out",
            args.latents,
    ...
    command = [
        sys.executable,
        "scripts/dev/estimate_quant_bound.py",
        "--latent-cache",
        args.latents,
        "--bases",
        args.bases,
    ...
    if not args.skip_quant_reconstruction:
        command = [
            sys.executable,
            "scripts/dev/test_quant_reconstruction.py",
            "--latent-cache",
            args.latents,
            "--bases",
            args.bases,
    ...
    command = [
        sys.executable,
        "scripts/sample/reconstruct_micro_real_zl.py",
        "--micro-checkpoint",
    ...
    command = [
        ...
        "--micro-out",
        "outputs/full_samples/generated_zL_micro_only.png",
        "--comparison-out",
        "outputs/full_samples/generated_zL_macro_micro_full.png",
        "--num-samples",
        str(args.sample_num_samples),
        "--sampler",
        args.sampler,
